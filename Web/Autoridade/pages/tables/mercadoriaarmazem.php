                    ...
                    <div class="card">
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example ">
                                ...
                                <tbody>
                                    <?php
                                    $sqlc="SELECT * FROM mercadoria WHERE disponivel='2';";
                                    ...
                                    <tr>
                                        ...
                                        $preco=($dias-7)*2;
                                        ?>
                                        <td><?php echo $preco." USD";}?></td>
                                        <?php echo "<td><a onclick=\"return confirm('Tem certeza que tirar a mercadoria MR$cod?');\" href='apreender.php?codigo= MR$cod'> Sim </a></td>";?>
                                    <?php
                                          }
