                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example ">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Email</th>
                                        <th>Passageiros</th>
                                        <th>Tipo de Camiao</th>
                                        <th>Pais de Origem</th>
                                        <th>Previsao da Chegada</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $sqlc="SELECT * FROM camiao WHERE chegada>$data;";
                                    $resultc=mysqli_query($connect,$sqlc);
                                    while($rowc=mysqli_fetch_assoc($resultc)){
                                    ?>
                                    <tr>
                                        <th scope="row"><?php echo "CM".$rowc["nup"];?></th>
                                        <td><?php echo $rowc["matricula"];?></td>
                                        <td><?php echo $rowc["empresa"];?></td>
                                        <td><?php echo $rowc["telefone"];?></td>
                                        <td><?php echo $rowc["email"];?></td>
                                        <td><?php echo $rowc["passageiros"];?></td>
