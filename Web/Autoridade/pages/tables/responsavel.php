                        ...
                        <div class="card">
                            <div class="body">
                                <table class="table table-bordered table-striped table-hover js-basic-example ">
                                    ...
                                    <tbody>
                                        <?php
                                        $sqlc = "SELECT * FROM responsavel;";
                                        $resultc = mysqli_query($connect, $sqlc);
                                        while ($rowc = mysqli_fetch_assoc($resultc)) {
                                            $cod = $rowc["nup"];
                                            ?>
                                            <tr>
                                                <th scope="row"><?php echo "RS" . $rowc["nup"]; ?></th>
                                                <td><?php echo $rowc["nome"]; ?></td>
                                                <td><?php echo $rowc["telefone"]; ?></td>
                                                <td><?php echo $rowc["email"]; ?></td>
                                                <td><?php echo $rowc["endereco"]; ?></td>
                                                <?php
                                                echo "<td><a onclick=\"return confirm('Tem certeza que quer apagar o responsavel RS$cod?');\" href='apagarresponsavel.php?codigo= RS$cod'> Sim </a></td>";
                                            }
