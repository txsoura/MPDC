...
if ($chegada < $data) {
    ...
    $sqld = "UPDATE navio SET chegada='$chegada',passageiros='$passageiro',partida='NULL', preco='0' WHERE nup='$_SESSION[codigo]';";
    if (mysqli_query($connect, $sqld)) {

        echo("<script language='javascript' type='text/javascript'>alert('Chagada marcada');window.location.href='chegada.php';</script>");
    }
}
