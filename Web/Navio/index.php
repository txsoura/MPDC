                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="pages/forms/mercadoria.php">Declarar</a>
                                </li>
                                <li>
                                    <a href="pages/tables/mercadoriad.php">Disponivel</a>
                                </li>
                                <li>
                                    <a href="pages/tables/mercadoriai.php">Indisponivel</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="info-box bg-cyan hover-expand-effect">
                            ...
                            <div class="content">
                                <div class="text">Mercadoria Descarregada</div>
                                <?php
                                $sqlmd = "SELECT COUNT(*) AS total FROM mercadoria WHERE navio='$_SESSION[codigo]' and disponivel='2' ;";
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="info-box bg-light-green hover-expand-effect">
                            ...
                            <div class="content">
                                <div class="text">Mercadoria na Embarcacao</div>
                                <?php
                                $sqlm = "SELECT COUNT(*) AS total FROM mercadoria WHERE navio='$_SESSION[codigo]' and disponivel='1';";
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="info-box bg-red hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <?php
                                $sql = "SELECT (preco) FROM navio WHERE nup='$_SESSION[codigo]';";
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover dashboard-task-infos">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql2 = "SELECT * FROM mercadoria WHERE navio='$_SESSION[codigo]';";
                                            $result2 = mysqli_query($connect, $sql2);
                                            while ($row2 = mysqli_fetch_assoc($result2)) {
                                                if ($row2["disponivel"] == 0 || $row2["disponivel"] == 1) {
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo "RS" . $row2["responsavel"]; ?></td>
                                                ...
                                                if ($row2["disponivel"] == 2) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row2["quantidade"] . " T"; ?></td>
                                                        <td><?php echo "RS" . $row2["responsavel"]; ?></td>
                                                        <td><span class="label bg-red">Descarregada</span></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
