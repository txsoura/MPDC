            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Chegada do Comboio</h2>
                            </div>
                            <div class="body">
                                <form id="form_validation" method="post" action="chegadaphp.php">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="date" class="form-control" name="chegada" value="<?php echo $datax; ?>" required>
                                    ...
                                    <a href=../../index.php><button type="button" class="btn btn-secundary waves-effect">Cancelar</button></a>
                                </form>
                            </div>
                        </div>
                    </div>
