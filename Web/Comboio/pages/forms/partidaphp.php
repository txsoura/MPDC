...
if ($partida < $data) {
    ...
    $sql = "SELECT * FROM comboio WHERE nup='$_SESSION[codigo]';";
    ...
    $sqld = "UPDATE comboio SET partida='$partida',passageiros='$passageiro' preco='$preco' WHERE nup='$_SESSION[codigo]';";
    if (mysqli_query($connect, $sqld)) {

        echo("<script language='javascript' type='text/javascript'>alert('Partida marcada');window.location.href='partida.php';</script>");
    }
}
