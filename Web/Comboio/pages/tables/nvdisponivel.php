                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="active">
                            ...
                            <ul class="ml-menu">
                                <li class="active">
                                    <a href="nvdisponivel.php">Disponivel</a>
                                </li>
                                <li>
                                    <a href="nvchegada.php">Previsao de Chegada</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                        ...
                        <div class="card">
                            <div class="body">
                                <table class="table table-bordered table-striped table-hover js-basic-example ">
                                    ...
                                    <tbody>
                                        <?php
                                        $sqlc = "SELECT * FROM navio WHERE chegada<=$datax and chegada!=NULL;";
                                        $resultc = mysqli_query($connect, $sqlc);
                                        while ($rowc = mysqli_fetch_assoc($resultc)) {
                                            ?>
                                            <tr>
                                                <td><?php echo "NV" . $rowc["nup"]; ?></td>
