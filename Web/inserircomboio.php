...
if (mysqli_num_rows($result) > 0) {
    echo("<script language='javascript' type='text/javascript'> alert('Comboio Invalido, ja foi registado. Por favor inicie sessao.');window.history.back();</script>");
} else {
    ...
    $sql = "INSERT INTO comboio (matricula,empresa,telefone,email,tipo,pais,nup) VALUES('$matricula','$empresa','$telefone','$email','$tipo','$pais','$nup');";
    if (mysqli_query($connect, $sql)) {
        $sql = "INSERT INTO usuario (senha,tipo) VALUES ('$senha','cb');";
        $result = mysqli_query($connect, $sql);
        ...
        <table>
        <tr>
        <th align='center'>Informacoes do Comboio</th>
        </tr>
        <tr>
        ...
        <tr>
        <td><b>Tipo de Comboio: </b>" . $tipo . "</td>
        </tr>
        <tr>
        <td><b>NUP:</b> CB" . $nup . "</td>
        </tr>
        </table>
        <br />
        <b>Notas</b><br />
        ...
        <b>&#8226;</b>Apos 2 dias, serao acrescentados 1.1 USD no valor diario;
        </body>
        </html>";
        $arquivo = "MPDC/CB.pdf";
        $mpdf = new mPDF();
        ...
        echo("<script language='javascript' type='text/javascript'>alert();window.location.href='comboio.php';</script>");
    }
