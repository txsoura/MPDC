...
<html lang="pt" class="no-js">
    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="comboio.php">Comboio</a></li>
        ...
        <!--========== PARALLAX ==========-->
        <div class="parallax-window" data-parallax="scroll" data-image-src="img/1920x1080/16.jpg">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-5 sm-margin-b-30">
                            <form name="reserva" method="post" action="inserircomboio.php">
                                ...
                                <p><select name="tipo" id="appearance-select" required>
                                        <option> Selecione o Tipo de Comboio... </option>
                                ...
                                <input type="password" class="form-control footer-input margin-b-20" name="senha"  placeholder="Senha (7 digitos)" required>                                  
