                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="info-box bg-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <?php
                            $sqlmd="SELECT COUNT(*) AS total FROM mercadoria WHERE responsavel='$_SESSION[codigo]' and disponivel='2' ;";
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <?php
                            $sqlm="SELECT COUNT(*) AS total FROM mercadoria WHERE responsavel='$_SESSION[codigo]' and disponivel='1';";
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="info-box bg-red hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <?php
                            $sqlma="SELECT COUNT(*) AS total FROM mercadoria WHERE responsavel='$_SESSION[codigo]' and disponivel='4';";
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sql2="SELECT * FROM mercadoria WHERE responsavel='$_SESSION[codigo]';";
                                        ...
                                        <td><?php echo $row2["quantidade"]." T";?></td>
                                        <td><?php echo "NV".$row2["navio"];?></td>
                                            <td><span class="label bg-blue">No Navio Atracado</span></td>
                                        </tr>
                                        <?php
                                            }
                                        ...
                                        <td><?php echo $row2["quantidade"]." T";?></td>
                                        <td><?php echo "NV".$row2["navio"];?></td>
                                            <td><span class="label bg-green">Descarregada</span></td>
                                        </tr>
                                        <?php
                                            }
