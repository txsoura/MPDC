                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Situacao de Mercadoria</th>
                                            <th>Quantidade</th>
                                            <th>Chegada</th>
                                            <th>Preco</th>
                                            <th>Tirar do Porto</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $sqlc = "SELECT * FROM mercadoria WHERE responsavel='$_SESSION[codigo]' and disponivel='2';";
                                        ...
                                        while ($rowc = mysqli_fetch_assoc($resultc)) {
                                            ...
                                            <tr>
                                                ...
                                                if ($dias <= 7) {
                                                    ?>
                                                    <td><?php echo "0 USD"; ?></td>
                                                    <?php
                                                } else {
                                                    $preco = ($dias - 7) * 2;
                                                    ?>
                                                    <td><?php echo $preco . " USD";
                                        } ?></td>
                                                <?php echo "<td><a onclick=\"return confirm('Tem certeza que tirar a mercadoria MR$cod?');\" href='tirar.php?codigo= MR$cod'> Sim </a></td>"; ?>
                                                <?php
                                            }
